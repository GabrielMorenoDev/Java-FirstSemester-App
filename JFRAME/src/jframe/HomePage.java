...
public class HomePage extends javax.swing.JFrame {
    ...
    Color roxo = new Color(102,102,255);
    ...
    private void initComponents() {
        ...
        tabelaCarrinho.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome produto", "Valor produto", "Descrição produto", "Quantidade", "Valor total"
            }
        ) {
            Class[] types = new Class [] {
        ...
        tabelaCarrinho.setColumnSelectionAllowed(true);
        ...
        jLabel53.setText("<html>Camiseta vitória royale Fornai Brand.<html>");
    ...
    private void op1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_op1MouseClicked
        if (op1.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA

        } else if (op2.getBackground().equals(cinza)
            || op3.getBackground().equals(cinza)
            || op4.getBackground().equals(cinza)
            || op5.getBackground().equals(cinza)
            || op6.getBackground().equals(cinza)
            || alterarCliente.getBackground().equals(cinza)
            || alterarAdm.getBackground().equals(cinza)
            || modaAtual.getBackground().equals(cinza)
            || op7.getBackground().equals(cinza)
            || opProd.getBackground().equals(cinza)){
            op2.setBackground(roxo);
            op3.setBackground(roxo);
            op4.setBackground(roxo);
            op5.setBackground(roxo);
            op6.setBackground(roxo);
            op7.setBackground(roxo);
            opProd.setBackground(roxo);
            alterarCliente.setBackground(roxo);
            alterarAdm.setBackground(roxo);
            modaAtual.setBackground(roxo);
            panelProduto.setVisible(false);
            panelReclamacao.setVisible(false);
            panelModa.setVisible(false);
            panelHistorico.setVisible(false);
    ...
    private void op2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_op2MouseClicked
        if (op2.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
            panelRoupa.setVisible(true);
        } else if (op1.getBackground().equals(cinza)
            || op5.getBackground().equals(cinza)
            || op3.getBackground().equals(cinza)
            || op4.getBackground().equals(cinza)
            || op6.getBackground().equals(cinza)
    ...
    private void op6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_op6MouseClicked
        if (op6.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA

        } else if (op1.getBackground().equals(cinza)
            || op2.getBackground().equals(cinza)
            || op3.getBackground().equals(cinza)
            || op4.getBackground().equals(cinza)
            || op5.getBackground().equals(cinza)
            || alterarCliente.getBackground().equals(cinza)
    ...
    private void op4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_op4MouseClicked
        if (op4.getBackground().equals(cinza)){
        // JÁ ESTÁ CINZA
    ...
    private void op3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_op3MouseClicked
        if (op3.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
    ...
    private void op5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_op5MouseClicked
        if (op5.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
    ...
    private void alterarClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_alterarClienteMouseClicked
        if (alterarCliente.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
            atualizarClientes();
        } else if (op1.getBackground().equals(cinza)
            || op2.getBackground().equals(cinza)
            ...
            alterarCliente.setBackground(cinza);
    ...
    private void alterarAdmMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_alterarAdmMouseClicked
        // ALTERAR ADM
        if (alterarAdm.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
            atualizarAdm();
        } else if (op1.getBackground().equals(cinza)
            || op2.getBackground().equals(cinza)
            ...
            alterarAdm.setBackground(cinza);
    ...
    public void verificaPaginas(){
        if(op1.getBackground().equals(cinza)){
            ...
            //ROUPA
            panelRoupa.setVisible(true);
        }else if(op3.getBackground().equals(cinza)){
            //TENIS
            panelTenis.setVisible(true);
        }else if(op4.getBackground().equals(cinza)){
            //HISTÓRICO
            panelHistorico.setVisible(true);
        }else if(op5.getBackground().equals(cinza)){
            //CARRINHO
            panelCarrinho.setVisible(true);
        }else if(op6.getBackground().equals(cinza)){
            // SAC
            panelSac.setVisible(true);
        }else if(modaAtual.getBackground().equals(cinza)){
    ...
    private void modaAtualMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_modaAtualMouseClicked
        // ALTERAR ADM
        if (modaAtual.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
    ...
    private void op7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_op7MouseClicked
        if (op7.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
    ...
    private void opProdMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_opProdMouseClicked
        if (opProd.getBackground().equals(cinza)){
            // JÁ ESTÁ CINZA
            atualizaProduto();
        } else if (op1.getBackground().equals(cinza)
            || op2.getBackground().equals(cinza)
